  ...
  return generator.generateDocument({
    ...
    info: {
      ...
      description:
        ...
        "If you exceed the allowed number of requests within the time window, " +
        "the API returns a `429 Too Many Requests` response with a message indicating how many seconds to wait before retrying.",
    },
    tags: [
      {
        name: "Bookmarks",
