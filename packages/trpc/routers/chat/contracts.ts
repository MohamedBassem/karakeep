...
const piMessageMetadataSchema = z.custom<StoredPiMessage>(
  (value) =>
    typeof value === "object" &&
    value !== null &&
    "role" in value &&
...
export const dbChatMessageSchema = chatMessageSchema.extend({
  chatId: z.string(),
  metadata: piMessageMetadataSchema.nullable(),
});
...
export type PersistedChatMessage = z.infer<typeof dbChatMessageSchema>;
