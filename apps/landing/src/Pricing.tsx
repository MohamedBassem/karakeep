...
function FAQ() {
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Yes, you can switch between monthly and yearly billing at any time from your subscription settings. When switching to yearly, you'll be credited for the remaining time on your current billing period.",
    },
    {
