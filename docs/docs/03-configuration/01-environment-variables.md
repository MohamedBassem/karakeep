...
| INFERENCE_CHAT_ENABLED               | No       | true                   | Whether the AI chat assistant is enabled or disabled. Requires `OPENAI_API_KEY` to be set.                                                                                                                                                                                                                                                                                            |
| INFERENCE_CHAT_MODEL                 | No       | INFERENCE_TEXT_MODEL    | The model to use for the AI chat assistant. Defaults to the value of `INFERENCE_TEXT_MODEL` if not set.                                                                                                                                                                                                                                                                                |
